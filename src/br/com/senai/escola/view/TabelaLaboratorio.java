 ...
 * @author Usuário
 */
public class TabelaLaboratorio extends javax.swing.JFrame {
    
      private LaboratorioTableModel model;
    /**
     * Creates new form TabelaProfessores
     */
    public TabelaLaboratorio() {
        initComponents();
        List<Laboratorio> lista = new ArrayList<Laboratorio>();
        LaboratorioController a = new LaboratorioController();
        lista = a.listarLaboratorio();

      
        model = new LaboratorioTableModel(lista);

        
        TabelaLaboratorios.setModel(model);
    ...
    private void initComponents() {
        ...
        TabelaLaboratorios = new javax.swing.JTable();
        ...
        jLabel4.setText("Laboratorio Reservado");
        jPanel1.add(jLabel4);
        ...
        TabelaLaboratorios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(TabelaLaboratorios);
    ...
    private void botaoIserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoIserirActionPerformed
        ReservaLaboratorio im = new ReservaLaboratorio(model);    
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        int selecionado = -1;
        selecionado = TabelaLaboratorios.getSelectedRow();

        if (selecionado >= 0) {
            Integer i = (Integer) model.getValueAt(selecionado, 0);
            Laboratorio m = model.getLaboratorio(selecionado);
            LaboratorioController mc = new LaboratorioController();
            mc.excluir(i);
            model.removeLaboratorio(selecionado);
    ...
    private void botaoEditar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditar1ActionPerformed
      int selecionado = -1;
        ...
        if (selecionado >= 0) {
            Integer cdLaboratorio = (Integer) model.getValueAt(selecionado, 0);
            EditarReservaLaboratorio am = new EditarReservaLaboratorio(selecionado, cdLaboratorio, model);
    ...
    private void campoNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoNomeActionPerformed
      ...
      private void efetuaPesquisa() {
        ...
        List<Laboratorio> lista = new ArrayList<Laboratorio>();
        LaboratorioController a = new LaboratorioController();
        lista = a.listarLaboratorioByNome(turno);
        model.limpar();
    ...
    private javax.swing.JTable TabelaLaboratorios;
