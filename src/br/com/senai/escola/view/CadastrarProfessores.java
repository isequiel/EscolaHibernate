...
public class CadastrarProfessores extends javax.swing.JFrame {
     ...
     */
    public CadastrarProfessores(ProfessorTableModel ptb) {
        initComponents();
        model = ptb;
    ...
    private void initComponents() {
        ...
        compoDisciplina.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        rbMasculino.setBounds(50, 310, 90, 30);
        ...
        rbFeminino.setBounds(160, 310, 90, 30);
    ...
    private void BotaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoSalvarActionPerformed
       Professor f = new Professor();
            ...
            if(mc.salvar(f)){
            model.addProfessor(pesquisar(f.getNome(), f.getTelefone()));
            }
      ...
      private Professor pesquisar (String nome, String telefone){
        ProfessorController pf = new ProfessorController();
        return pf.listarProfessorByNomeTelefone(nome, telefone);
    }
